...
def main():
    ...
    base_generated = Path("experimental/projects/django-rest-framework/doxen_output/guides")
    ...
    output_path = Path("experimental/analysis/evaluation_reports/tier3_validation_report.json")
    import json
